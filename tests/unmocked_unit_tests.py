"""Unmocked Tests"""
# pylint: disable=wrong-import-position,too-many-instance-attributes,unused-import,consider-using-in
import sys
...
ABOUT_CORRECT = (
    "A bot created for this project I am... Type !!help, my commands to see. Yes, hrrmmm."
)
HELP_CORRECT = (
...
READY_CORRECT_2 = (
    "This one, a long time have I watched. When gone am I, the last of the Jedi will you be."
)
COMMAND_INCORRECT = (
...
class UnmockedTestCases(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.success_chatbot_about = [
            {KEY_INPUT: "!!about", KEY_EXPECTED: ABOUT_CORRECT},
            {KEY_INPUT: "!about", KEY_EXPECTED: COMMAND_INCORRECT},
            {KEY_INPUT: "!! about", KEY_EXPECTED: COMMAND_INCORRECT},
            {KEY_INPUT: "!!abouts", KEY_EXPECTED: COMMAND_INCORRECT},
        ]
        ...
        self.failure_chatbot_about = [
            ...
            {KEY_INPUT: "!about", KEY_EXPECTED: ABOUT_CORRECT},
            {KEY_INPUT: "!! about", KEY_EXPECTED: ABOUT_CORRECT},
            {KEY_INPUT: "!!abouts", KEY_EXPECTED: ABOUT_CORRECT},
        ]

        self.success_chatbot_help = [
            {KEY_INPUT: "!!help", KEY_EXPECTED: HELP_CORRECT},
            {KEY_INPUT: "!help", KEY_EXPECTED: COMMAND_INCORRECT},
            {KEY_INPUT: "!! help", KEY_EXPECTED: COMMAND_INCORRECT},
            {KEY_INPUT: "!!helpp", KEY_EXPECTED: COMMAND_INCORRECT},
            {KEY_INPUT: "!!help!!!!", KEY_EXPECTED: COMMAND_INCORRECT},
            {KEY_INPUT: "!!help plz", KEY_EXPECTED: COMMAND_INCORRECT},
        ]

        self.failure_chatbot_help = [
            {KEY_INPUT: "!!help", KEY_EXPECTED: COMMAND_INCORRECT},
            {KEY_INPUT: "!!help", KEY_EXPECTED: ABOUT_CORRECT},
            {KEY_INPUT: "!help", KEY_EXPECTED: HELP_CORRECT},
            {KEY_INPUT: "!! help", KEY_EXPECTED: HELP_CORRECT},
            {KEY_INPUT: "!!helpp", KEY_EXPECTED: HELP_CORRECT},
            {KEY_INPUT: "!!help me plz", KEY_EXPECTED: HELP_CORRECT},
        ]
        ...
        self.success_bot_command_call = [
            {KEY_INPUT: "!!about", KEY_EXPECTED: None},
            {KEY_INPUT: "!!quote", KEY_EXPECTED: None},
            {KEY_INPUT: "!!help", KEY_EXPECTED: None},
        ]
    ...
    def test_bot_failure_command_call(self):
        """Failure bot command call function"""
